  ...
  return Promise.join(
    ...
    knex("users").insert([
      ...
      },
      {
        ...
        bio: "My hobbies include surfing, playing the ukelele, and watching videos of girls.",
        idToken: "test-token",
      },
      {
        user_id: 8,
      ...
      },
      {
        ...
        bio: "I lived in Argentina for a year and would love to go back there someday!",
        idToken: "test-token",
      },
    ]),
    knex("blogs").insert([
    ...
    knex("media").insert([
      {
        user_id: 1,
        country_id: 97,
        image_url: "https://s3.amazonaws.com/griffyndor/demand-response-Japan.jpg",
      },
      {
        user_id: 1,
        country_id: 97,
      ...
      },
      {
        user_id: 2,
        country_id: 97,
        image_url: "https://s3.amazonaws.com/griffyndor/Japan-McMandy/Doraemon-.jpg",
      },
      {
        user_id: 2,
        country_id: 97,
        image_url: "https://s3.amazonaws.com/griffyndor/Japan-McMandy/girls_in_japan.jpg",
      },
      {
        user_id: 2,
        country_id: 97,
